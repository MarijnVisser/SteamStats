		...
		<div class="card mt-3" style="background-color: #282e39">
		    <div class="card-body ">
		        <div class="row mb-3 mt-md-0">
		            <div class="col-md-12">
						<form action="{{ route('destroyreview') }}" method="post">
						    ...
						    <div class="form-group">
						        ...
						        <select class="form-control" name="stars" disabled="true" disabled="true">
						    ...
						    <div class="form-group">
						        <label>Review</label>
						        <textarea class="form-control" name="review" rows="5" readonly="true">{{ $review['review'] }}</textarea>
						    </div>
